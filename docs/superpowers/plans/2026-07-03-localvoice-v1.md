...
CASES = [
    ...
    (S.PROCESSING, ev(E.PIPELINE_ERROR), S.IDLE, (A.TRUNCATE_HISTORY, A.FLUSH_AUDIO, A.REPORT_ERROR)),
...
_BARGE_IN = (A.CANCEL_PIPELINE, A.TRUNCATE_HISTORY, A.FLUSH_AUDIO, A.EARCON_START, A.START_CAPTURE)
_CANCEL = (A.CANCEL_PIPELINE, A.TRUNCATE_HISTORY, A.FLUSH_AUDIO, A.EARCON_CANCEL)
_ERROR = (A.TRUNCATE_HISTORY, A.FLUSH_AUDIO, A.REPORT_ERROR)
